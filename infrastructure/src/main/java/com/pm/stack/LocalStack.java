...
public class LocalStack extends Stack {
    ...
    private Vpc createVpc() {
        return Vpc.Builder
                ...
                .maxAzs(2)
                // Explicitly define subnets to ensure Private subnets exist
    ...
    private CfnCluster createMskCluster() {
        // Select the private subnets explicitly
        List<String> subnetIds = vpc.getPrivateSubnets().stream()
                .map(ISubnet::getSubnetId)
                .limit(2) // Ensure we take exactly 2
        ...
        return CfnCluster.Builder.create(this, "MskCluster")
                ...
                .brokerNodeGroupInfo(CfnCluster.BrokerNodeGroupInfoProperty.builder()
                        ...
                        .clientSubnets(subnetIds) // Pass the verified list of 2 IDs
